...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖 𝗨𝗽𝗱𝗮𝘁𝗲𝘀 🤖', url='https://t.me/Mc_Films_Update')
            ],
            [
                InlineKeyboardButton('ℹ️ 𝑯𝒆𝒍𝒑 ℹ️', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('➕ 𝗔ᴅᴅ 𝗠ᴇ 𝗧ᴏ 𝗬ᴏᴜʀ 𝗚ʀᴏᴜᴘ ➕', url=f"https://t.me/{temp.U_NAME}?startgroup=true")
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('♂️Uᴘᴅᴀᴛᴇ', url='https://t.me/Mc_Films_Update'),InlineKeyboardButton('📢Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url='https://t.me/Mc_Group_Films') ], [ InlineKeyboardButton('👑Bᴏᴛ Oᴡɴᴇʀ', url='https://t.me/Thiraniitsme') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
